...
#define USART2TxRx	GPIOA,GPIO_Pin_2,GPIOA,GPIO_Pin_3
#define USART3TxRx	GPIOB,GPIO_Pin_10,GPIOB,GPIO_Pin_11

SerialInterface *Serial0::interface;

int Serial0::_setup(int baudrate, SerialInterface &interfaceArg, int parity, int wordLength)
{
	Init_USART(USART2,baudrate,USART2TxRx,parity,wordLength);
...
{
	Init_USART(USART3,baudrate,USART3TxRx,parity,wordLength);
	interface=&interfaceArg;
	//interface->serialInterfaceSetup(transmit);
	return 0;
}
